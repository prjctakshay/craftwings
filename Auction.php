                     ...
                     <div class="caption">
                        ...
                        ?>
                           <form action="bid_last.php" method="post" name="placebid">
                              ...
                              <input type="hidden" id="date" name="end_date" value="04-04-2021">
