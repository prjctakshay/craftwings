            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href=https://youtu.be/laoUeh8I2XM>
                                <img src="img/aranmula.jpg" alt="aranmula">
                            </a>
                       <!--    <iframe src="https://www.youtube.com/embed/PNMCxAF0XQM" frameborder="0" allowfullscreen></iframe>-->
                            <center>
                                <div class="caption">
                                    <h3>Aranmula Kannadi</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href=https://youtu.be/laoUeh8I2XM>
                                <img src="img/nettupetti.jpg" alt="nettupetti">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Nettupetti</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href=https://youtu.be/laoUeh8I2XM>
                                <img src="img/wdelephant.jpg" alt="wood_elephant">
                            </a>
                            <center>
                                <div class="caption">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href=https://youtu.be/laoUeh8I2XM>
                                <img src="img/Kathakali-Mask.jpg" alt="kathakali">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href=https://youtu.be/laoUeh8I2XM>
                                <img src="img/kubera.jpg" alt="kubera">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Kubera statue</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href=https://youtu.be/laoUeh8I2XM>
                                <img src="img/nirapara.jpg" alt="nirapara">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Nirapara</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href=https://youtu.be/laoUeh8I2XM>
                                <img src="img/palakka.jpg" alt="palakka">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Palakka Necklace</h3>
